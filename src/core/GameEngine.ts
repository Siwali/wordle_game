import type { GameState, GameEvent, RenderState } from '../types/index.js'
...
export class GameEngine {
  ...
  handleInput(event: GameEvent): void {
    ...
    if (event.type !== 'reset' && event.type !== 'restart' && this.state.status !== 'playing') return
   ...
   */
  calculateFeedbackForGuess(guess: string): ReturnType<typeof calculateFeedback> {
