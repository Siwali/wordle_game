 ...
 */
export function createHeader(level) {
 ...
 */
export function createRestartButton(onClick) {
    const button = document.createElement('button');
 ...
 */
export function createMessage(message, status) {
 ...
 */
export function createTile(letter, status) {
 ...
 */
export function createGuessRow(guess, feedback) {
    const row = createRow();
 ...
 */
export function createInputRow(currentInput, targetWordLength) {
    const row = createRow();
 ...
 * Create an empty row
 */
export function createEmptyRow(targetWordLength) {
    const row = createRow();
    for (let j = 0; j < targetWordLength; j++) {
